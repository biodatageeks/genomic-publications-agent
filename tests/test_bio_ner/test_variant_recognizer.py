...
from src.bio_ner.variant_recognizer import VariantRecognizer
...
class TestVariantRecognizer:
    ...
    @patch('src.bio_ner.variant_recognizer.LlmManager')
    ...
    @patch('src.bio_ner.variant_recognizer.VariantRecognizer.recognize_variants_text')
