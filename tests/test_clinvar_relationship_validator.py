...
from src.clinvar_relationship_validator import ClinvarRelationshipValidator, ValidationReport, ValidationError
...
class TestClinvarRelationshipValidator:
    ...
    @patch("src.clinvar_client.clinvar_client.ClinVarClient")
